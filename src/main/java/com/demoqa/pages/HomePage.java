...
public class HomePage extends BasePage {
    ...
    private By elementsCard = By.xpath("//*[@id='app']//h5[text()='Elements']");
    private By widgetsCard = By.xpath("//*[@id='app']//h5[text()='Widgets']");
    private By alertsFrameWindowsCard = By.xpath(("//*[@id='app']//h5[contains(text(),'Alerts')]"));
